/**
 * Tests for Kizu to PenPot Converter (end-to-end)
 * Tests the full conversion pipeline from kizu format to PenPot flat format.
 */

const converter = require('../src/services/kizu-to-penpot-converter');
...
/**
 * Build a minimal kizu project for testing
 * @param {array} pages - Pages array
 * @returns {object} Kizu project
 */
